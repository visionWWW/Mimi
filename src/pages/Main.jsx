...
class Main extends React.Component {
    ...
    return (
        ...
        <Tabs style={Wrap}>
            ...
            <TabPanel>
            <p>
            사용자의 심리분석 웹 서비스를 통해 이용자의 기분에 따른 음식성분과 음식점을 추천하는 웹 서비스입니다.<br/>
            ...
            **특장점** <br/>
            ...
            - **머신러닝을 이용한 심리상태에 맞는 음식 성분 및 음식 추천 기능**<br/>
            : 사용자에게 적합한 음식성분과 음식점 추천<br/>
            : 일상생활에 필수적인 음식과 사람의 감정간의 상관관계를 통한 올바른 식습관 문화를 형성<br/>
            : 코로나로 건강 및 식단을 중요하게 생각하는 사람들에게 양질의 정보 제공<br/>

            - **지도 필터링 기능으로 사용자 주변 음식점 소개**<br/>
            : 사용자 위치를 기반으로 추천음식에 대한 음식점 소개<br/>
            : 음식점 위치와 음식성분을 아이콘으로 지도에 시각화<br/>

            - **음식점 후기 제공**<br/>
            : 소비자의 리뷰를 통해 추천 알고리즘에 대한 솔직한 후기 제공<br/>
            </TabPanel>
            <TabPanel>
            **1. 사용자 심리상태에 적절한 음식 정보 제공**<br/>
